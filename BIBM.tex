...
\begin{tikzpicture}[remember picture, overlay]
   ...
   % define location of title
    ...
    \node[anchor=east] at (logoloc) 
        {\includegraphics[width=9cm]{Figs/logo.png}}; % Adjust logo size as needed
   ...
   \node[blue!20!black,font=\fontsize{38}{30}\bfseries,align=justify] at (center) [xshift=39cm,yshift=57cm] { MMP };
    ...
    \coordinate (cellloc) at ([xshift=12cm, yshift=-52cm] current page.north west);
     ...
     \node[anchor=east] at (cellloc)  [xshift=0cm, yshift=-2cm]
        {\includegraphics[ width=10cm]{Figs/nuclei.png}};
     \node[anchor=east] at (cellloc) [xshift=11cm, yshift=-2cm]
        {\includegraphics[ width=10cm]{Figs/cytosol.png}};

     \node[anchor=east] at (cellloc) [xshift=22cm, yshift=-2cm]
        {\includegraphics[ width=10cm]{Figs/mitho.png}};
    


    %cartoons
    \node[anchor=east] at (cellloc)  [xshift=-2.5cm, yshift=-10cm]
        {\includegraphics[ width=5cm]{Figs/swell_nuclei.png}};

     \node[anchor=east] at (cellloc)  [xshift=8.5cm, yshift=-10cm]
        {\includegraphics[ width=5cm]{Figs/LMP.png}};
 

     \node[anchor=east] at (cellloc)  [xshift=19.5cm, yshift=-10cm]
        {\includegraphics[ width=5cm]{Figs/mitho_cartoon.png}};
...
% Calculate the coordinates of the big white circle
 ...
 \begin{scope}
        ...
        \node at (30.5,-29) {\includegraphics[width=16cm]{Figs/cell_death.png}};
    \end{scope}
...
\begin{scope}
        ...
        \node at (43.5,-37) {\includegraphics[width=16cm]{Figs/Annotation.png}};
    \end{scope}
...
\begin{scope}
        ...
        \node at (44.5,-50) {\includegraphics[clip,trim=0cm 0cm 0cm 0cm,width=12cm]{Figs/UNet.png}};
    \end{scope}
...
\begin{scope}
        ...
        \node at (44.5,-65) {\includegraphics[clip,trim=2cm 0cm 0cm 0cm,width=16cm]{Figs/healthy.png}};
    \end{scope}
...
\begin{scope}
        ...
        \node at (44.5,-84) {\includegraphics[clip,trim=2cm 0cm 0cm 0cm,width=18cm]{Figs/genome.png}};
    \end{scope}
...
\begin{scope}
        ...
        \node at (27.5,-102) {\includegraphics[clip,trim=0cm 0cm 0cm 0cm,width=18cm]{Figs/annot.png}};
    \end{scope}
...
% Dataset
    ...
    %Introduction text
     ...
     \node[anchor=east] at (cellloc)  [xshift=23cm, yshift=-35cm]
        {\includegraphics[ width=30cm]{Figs/dataset_new.png}};
...
$IOU(A,B) = \dfrac {A \cap B }{A\cup B}$
     ...
     \node[anchor=east] at (cellloc)  [xshift=68cm, yshift=-18cm]
        {\includegraphics[ clip,trim=1cm 0cm 3cm 0cm,width=21cm]{Figs/F1_score_val_test.png}};
...
The best model was applied to the full dataset, and the nuclei count and area for each well were plotted.
     ...
     \node[anchor=east] at (cellloc)  [xshift=68cm, yshift=-39cm]
        {\includegraphics[ clip,trim=1cm 0cm 3cm 0cm,width=21cm]{Figs/Nuclei_count.eps}};

        
     \node[anchor=east] at (cellloc)  [xshift=68cm, yshift=-52cm]
        {\includegraphics[ clip,trim=1cm 0cm 3cm 0cm,width=21cm]{Figs/Nuclei_area.eps}};
